Public Class F_Secundario
    ...
    Private Sub BTN_A_MateriaSiguiente_Click_1(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub BTN_A_AlumnoSiguiente_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub BTN_A_ProfesorSiguiente_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub BTN_A_CursoSiguiente_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub BTN_A_FacultadAceptar_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    'CLICK PARA ACEPTAR
    Private Sub BTN_A_CarreraAceptar_Click(sender As Object, e As EventArgs)
        ...
        Me.Close()
    End Sub
    Private Sub BTN_A_AlumnoAceptar_Click(sender As Object, e As EventArgs)
    ...
    Private Sub BTN_A_CorrelativaAceptar_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_AulaAceptar_Click(sender As Object, e As EventArgs)
        oAula.Codigo = TXT_A_CodigoAula.Text
        oAula.Descripcion = TXT_A_DescripcionAula.Text
        oAula.InsertarAula()
        Me.Close()
    End Sub
    Private Sub BTN_A_ProfesorAceptas_Click(sender As Object, e As EventArgs)
        ...
        Me.Close()
    End Sub
    Private Sub BTN_A_OtroAceptar_Click(sender As Object, e As EventArgs)
        ...
        Me.Close()
    End Sub
    Private Sub BTN_A_MateriaAgregar_Click(sender As Object, e As EventArgs)
        Materia.RelacionarCorrelativa()
    End Sub
    Private Sub BTN_A_ExamenFinalAceptar_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub PNL_A_Usuario_VisibleChanged(sender As Object, e As EventArgs)
        oConfiguracion.CargarComboBox(CMB_A_FacultadUsuario, PNL_A_Usuario, "FACULTAD", "DESCRIPCION")
    End Sub
    Private Sub PNL_A_Correlativa_VisibleChanged(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub BTN_A_AlumnoCancelar_VisibleChanged(sender As Object, e As EventArgs)
        oConfiguracion.CargarComboBox(CMB_A_SeleccionarFacultadAlumno, PNL_A_Alumno2, "FACULTAD", "DESCRIPCION")
    End Sub
    Private Sub PNL_A_ExamenFinal_VisibleChanged(sender As Object, e As EventArgs)
    ...
    End Sub
    'CANCELAR
    Private Sub BTN_A_FacultadCancelar_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_AlumnoCancelar_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_MateriaCancelar_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_AlumnoCancelar2_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_CorrelativaSalir_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub
    Private Sub BTN_A_ExamenFinalCancelar_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub

    Private Sub PNL_A_Correlativa_Paint(sender As Object, e As PaintEventArgs)
