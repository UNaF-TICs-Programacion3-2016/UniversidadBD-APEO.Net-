Public Class F_Secundario
    ...
    Private Sub BTN_A_ProfesorAceptas_Click_1(sender As Object, e As EventArgs) Handles BTN_A_ProfesorAceptas.Click
    ...
    Private Sub BTN_A_ProfesorCancelar_Click(sender As Object, e As EventArgs) Handles BTN_A_ProfesorCancelar.Click
        Me.Close()
    ...
    End Sub
    Private Sub PNL_E_Facultad_Paint(sender As Object, e As PaintEventArgs) Handles PNL_E_Facultad.Paint

    End Sub

    Private Sub PNL_A_ExamenFinal_Paint(sender As Object, e As PaintEventArgs) Handles PNL_A_ExamenFinal.Paint
